 ...
 */
public class FIXOrderOutputForTT<T extends AbstractOrder<T> & FIXAttributes> {
    ...
    protected final FixTag execTransType;
    ...
    public FIXOrderOutputForTT(FixParser parser,
                               FixStore store,
                               FIXQtyMode qtyMode,
        ...
        this.execTransType = parser.createWriteOnlyFIXTag(FixTags.ExecTransType);
    ...
    public void writeClientOrderReject(MatchClientOrderRejectEvent msg, long execSuffix) {
        ...
        writeInstrument(fix, securities.getBond(msg.getSecurity()));
    ...
    public void writeOrderReject(MatchOrderRejectEvent msg, long execSuffix) {
        ...
        writeInstrument(fix, securities.getBond(msg.getSecurityID()));
    ...
    public void writeFilledExecutionReport(long time,
        ...
        writeExecutionReport(time, order, 'X', execSuffix, ExecType.Fill, ordStatus, execQty, execPrice, null);
    }
    ...
    protected void writeExecutionReport(long time,
        ...
        writeInstrument(fix, securities.getBond(order.getSecurityID()));
    ...
    private void writeInstrument(FixWriter fix, Bond bond) {
        if(bond != null) {
            // 48=SecurityId*
            fix.writeString(securityId, bond.getCUSIP());

            // 55=Symbol*
            fix.writeString(symbol, bond.getName());
        }else{
            // 48=SecurityId*
            fix.writeString(securityId, "NONE");
        }
    }
