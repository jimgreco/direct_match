...
public class OUCHTradeConfirmationByteBufferMessage implements 
	OUCHTradeConfirmationEvent, 
	OUCHTradeConfirmationCommand {
    ...
    @Override
    public void copy(OUCHTradeConfirmationEvent cmd) {
    ...
    @Override
    public OUCHTradeConfirmationEvent toEvent() {
        return this;
    }

    @Override
    public OUCHTradeConfirmationCommand toCommand() {
        return this;
    }
    ...
    public OUCHTradeConfirmationCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public OUCHTradeConfirmationEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
    ...
    private static class Offsets {
        ...
        static int ExecQty = 9;
        static int ExecPrice = 13;
        static int MatchID = 21;
        static int Side = 25;
        static int Security = 26;
        static int TradeDate = 38;
        static int TradeTime = 42;
        static int SettlementDate = 50;
        static int CommissionAmount = 54;
        static int Trader = 62;
    }
