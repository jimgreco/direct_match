...
public class OUCHOrderByteBufferMessage implements 
	OUCHOrderEvent, 
	OUCHOrderCommand {
    ...
    @Override
    public void copy(OUCHOrderEvent cmd) {
    ...
    @Override
    public OUCHOrderEvent toEvent() {
        return this;
    }

    @Override
    public OUCHOrderCommand toCommand() {
        return this;
    }
    ...
    public OUCHOrderCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public OUCHOrderEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
