...
public class OUCHCanceledByteBufferMessage implements 
	OUCHCanceledEvent, 
	OUCHCanceledCommand {
    ...
    @Override
    public void copy(OUCHCanceledEvent cmd) {
    ...
    @Override
    public OUCHCanceledEvent toEvent() {
        return this;
    }

    @Override
    public OUCHCanceledCommand toCommand() {
        return this;
    }
    ...
    public OUCHCanceledCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public OUCHCanceledEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
