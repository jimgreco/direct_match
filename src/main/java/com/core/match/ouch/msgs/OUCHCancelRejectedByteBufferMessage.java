...
public class OUCHCancelRejectedByteBufferMessage implements 
	OUCHCancelRejectedEvent, 
	OUCHCancelRejectedCommand {
    ...
    @Override
    public void copy(OUCHCancelRejectedEvent cmd) {
    ...
    @Override
    public OUCHCancelRejectedEvent toEvent() {
        return this;
    }

    @Override
    public OUCHCancelRejectedCommand toCommand() {
        return this;
    }
    ...
    public OUCHCancelRejectedCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public OUCHCancelRejectedEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
