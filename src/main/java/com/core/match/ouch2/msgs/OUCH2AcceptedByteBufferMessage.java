...
public class OUCH2AcceptedByteBufferMessage implements 
	OUCH2AcceptedEvent, 
	OUCH2AcceptedCommand {
    private static final int DEFAULT_LENGTH = 63;
    ...
    @Override
    public void copy(OUCH2AcceptedEvent cmd) {
    ...
    @Override
    public OUCH2AcceptedEvent toEvent() {
        return this;
    }

    @Override
    public OUCH2AcceptedCommand toCommand() {
        return this;
    }
    ...
    public OUCH2AcceptedCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public OUCH2AcceptedEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
