...
public class ITCHTradeByteBufferMessage implements 
	ITCHTradeEvent, 
	ITCHTradeCommand {
    ...
    @Override
    public void copy(ITCHTradeEvent cmd) {
    ...
    @Override
    public ITCHTradeEvent toEvent() {
        return this;
    }

    @Override
    public ITCHTradeCommand toCommand() {
        return this;
    }
    ...
    public ITCHTradeCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public ITCHTradeEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
