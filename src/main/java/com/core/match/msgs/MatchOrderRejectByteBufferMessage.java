...
public class MatchOrderRejectByteBufferMessage implements 
	MatchOrderRejectEvent, 
	MatchOrderRejectCommand {
    ...
    @Override 
    public void copy(MatchOrderRejectEvent cmd) {
    ...
    @Override
    public MatchOrderRejectEvent toEvent() {
        return this;
    }

    @Override
    public MatchOrderRejectCommand toCommand() {
        return this;
    }
    ...
    public MatchOrderRejectCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public MatchOrderRejectEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
    ...
    public String toString() {
        ...
        builder.append("Msg=OrderReject");
