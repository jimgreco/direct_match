...
public class MatchClientCancelReplaceRejectByteBufferMessage implements 
	MatchClientCancelReplaceRejectEvent, 
	MatchClientCancelReplaceRejectCommand {
    ...
    @Override 
    public void copy(MatchClientCancelReplaceRejectEvent cmd) {
    ...
    @Override
    public MatchClientCancelReplaceRejectEvent toEvent() {
        return this;
    }

    @Override
    public MatchClientCancelReplaceRejectCommand toCommand() {
        return this;
    }
    ...
    public MatchClientCancelReplaceRejectCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public MatchClientCancelReplaceRejectEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
    ...
    public String toString() {
        ...
        builder.append("Msg=ClientCancelReplaceReject");
