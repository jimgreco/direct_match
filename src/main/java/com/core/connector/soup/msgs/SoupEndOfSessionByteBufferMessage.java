...
public class SoupEndOfSessionByteBufferMessage implements 
	SoupEndOfSessionEvent, 
	SoupEndOfSessionCommand {
    ...
    @Override
    public void copy(SoupEndOfSessionEvent cmd) {
        setMsgLength(cmd.getMsgLength());
        setMsgType(cmd.getMsgType());
    }

    @Override
    public SoupEndOfSessionEvent toEvent() {
        return this;
    }

    @Override
    public SoupEndOfSessionCommand toCommand() {
        return this;
    }
    ...
    public SoupEndOfSessionCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public SoupEndOfSessionEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
    ...
    public String toString() {
        ...
        builder.append("Msg=EndOfSession");
