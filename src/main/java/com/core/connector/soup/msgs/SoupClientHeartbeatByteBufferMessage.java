...
public class SoupClientHeartbeatByteBufferMessage implements 
	SoupClientHeartbeatEvent, 
	SoupClientHeartbeatCommand {
    ...
    @Override
    public void copy(SoupClientHeartbeatEvent cmd) {
        setMsgLength(cmd.getMsgLength());
        setMsgType(cmd.getMsgType());
    }

    @Override
    public SoupClientHeartbeatEvent toEvent() {
        return this;
    }

    @Override
    public SoupClientHeartbeatCommand toCommand() {
        return this;
    }
    ...
    public SoupClientHeartbeatCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public SoupClientHeartbeatEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
    ...
    public String toString() {
        ...
        builder.append("Msg=ClientHeartbeat");
