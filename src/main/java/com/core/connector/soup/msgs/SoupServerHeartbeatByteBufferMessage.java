...
public class SoupServerHeartbeatByteBufferMessage implements 
	SoupServerHeartbeatEvent, 
	SoupServerHeartbeatCommand {
    ...
    @Override
    public void copy(SoupServerHeartbeatEvent cmd) {
        setMsgLength(cmd.getMsgLength());
        setMsgType(cmd.getMsgType());
    }

    @Override
    public SoupServerHeartbeatEvent toEvent() {
        return this;
    }

    @Override
    public SoupServerHeartbeatCommand toCommand() {
        return this;
    }
    ...
    public SoupServerHeartbeatCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public SoupServerHeartbeatEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
    ...
    public String toString() {
        ...
        builder.append("Msg=ServerHeartbeat");
