...
public class SoupSequencedDataByteBufferMessage implements 
	SoupSequencedDataEvent, 
	SoupSequencedDataCommand {
    ...
    @Override
    public void copy(SoupSequencedDataEvent cmd) {
    ...
    @Override
    public SoupSequencedDataEvent toEvent() {
        return this;
    }

    @Override
    public SoupSequencedDataCommand toCommand() {
        return this;
    }
    ...
    public SoupSequencedDataCommand wrapCommand(ByteBuffer buf) {
        buffer = buf;
        buffer.mark();
        buffer.put(EMPTY);
        buffer.reset();
    ...
    public SoupSequencedDataEvent wrapEvent(ByteBuffer buf) {
        buffer = buf;
    ...
    public String toString() {
        ...
        builder.append("Msg=SequencedData");
